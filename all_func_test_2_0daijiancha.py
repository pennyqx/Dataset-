...
def create_conebeam_backprojection( sinogram_np, geometry, patient_id, output_dir, detector_shape, detector_spacing): 
    """
    ...
    - detector_spacing (tuple): The spacing of the detector elements.
    ...
    base_name = f"{patient_id}_scale_{int(scale_factor * 100)}"
...
for patient_data in all_volumes:
    ...
    full_reconstruction = create_conebeam_backprojection(full_sinogram, geometry, patient_id, test_output_fullreco, detector_shape, detector_spacing)
    ...
    for scale_factor in scale_factors:
        ...
        truncated_reconstruction = create_conebeam_backprojection(truncated_sinogram, geometry, 
                                                                  ...
                                                                  test_output_trunc_recon, detector_shape, detector_spacing)
